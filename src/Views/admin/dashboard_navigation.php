                    ...
                    <ul class="flex flex-1 flex-col gap-y-7">
                        <li>
                            <ul class="-mx-2 space-y-1">
                                ...
                                <li>
                                    <a href="#cinema" class="hamburger-menu-link group flex items-center gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-zinc-100 hover:text-orange-600 transition duration-200">
                                        <svg class="h-5 w-5 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                ...
                                <li>
                                    <a href="#reservations" class="hamburger-menu-link group flex items-center gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-zinc-100 hover:text-orange-600 transition duration-200">
                                        <svg class="h-5 w-5 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
