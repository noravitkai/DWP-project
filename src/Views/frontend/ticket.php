...
<head>
    ...
    <title>Ticket <?php echo $ticketNumber; ?></title>
...
<body class="h-full bg-zinc-100 text-zinc-900 p-8">
    <div class="max-w-3xl mx-auto bg-white p-8 shadow-md">
        <div class="border-b border-zinc-200 pb-5 mb-5">
            <h1 class="text-3xl font-bold text-zinc-900">Ticket</h1>
            <p class="text-sm text-zinc-600 mt-2">Number: <?php echo $ticketNumber; ?></p>
