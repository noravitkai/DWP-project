...
<footer class="bg-zinc-900">
    <div class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
        <div class="lg:grid lg:grid-cols-2">
            <section class="border-b border-zinc-800 py-8 lg:order-last lg:border-b-0 lg:border-s lg:py-16 lg:ps-16">
            ...
            <section class="py-8 lg:py-16 lg:pe-16">
                ...
                <div class="sm:mt-8 grid grid-cols-1 gap-8 sm:grid-cols-3">
                    <nav aria-label="Sitemap" class="col-span-1">
                        <p class="max-w-lg text-sm sm:text-base text-orange-600">Sitemap</p>
                        <ul class="mt-6 space-y-4 text-sm">
                            <li>
                                <a href="<?php echo ($currentPage === 'home_page.php') ? '#screenings' : $navLink . 'screenings'; ?>" class="text-zinc-300 transition ease-in-out duration-300 hover:opacity-75">
                                    Screenings
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo ($currentPage === 'home_page.php') ? '#news' : $navLink . 'news'; ?>" class="text-zinc-300 transition ease-in-out duration-300 hover:opacity-75">
                                    News
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo ($currentPage === 'home_page.php') ? '#movies' : $navLink . 'movies'; ?>" class="text-zinc-300 transition ease-in-out duration-300 hover:opacity-75">
                                    Movies
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo ($currentPage === 'home_page.php') ? '#contact' : $navLink . 'contact'; ?>" class="text-zinc-300 transition ease-in-out duration-300 hover:opacity-75">
                                    Contact
                                </a>
                            </li>
                        </ul>
                    ...
                    <address class="col-span-1 not-italic">
                        <p class="max-w-lg text-sm sm:text-base text-orange-600">Contact Info</p>
                        <ul class="mt-6 space-y-4 text-sm">
                            <?php if ($cinema): ?>
                                <li>
                                    <a href="tel:<?php echo $cinema['PhoneNumber']; ?>" class="text-zinc-300 transition ease-in-out duration-300 hover:opacity-75">
                                        <?php echo $cinema['PhoneNumber']; ?>
                                    </a>
                                </li>
                                <li>
                                    <a href="mailto:<?php echo $cinema['Email']; ?>" class="text-zinc-300 transition ease-in-out duration-300 hover:opacity-75">
                                        <?php echo $cinema['Email']; ?>
                                    </a>
                                </li>
                            <?php else: ?>
                                <li class="text-zinc-300">No contact information available.</li>
                            <?php endif; ?>
                        </ul>
                    </address>
                </div>
