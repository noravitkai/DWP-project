...
<body class="bg-zinc-800 text-zinc-200"
    ...
    <main class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
        ...
        <div class="mb-8 flex flex-col sm:flex-row gap-4">
            ...
            <a href="ticket.php?reservationId=<?php echo urlencode($reservationId); ?>" 
               class="inline-flex items-center rounded-lg bg-orange-600 px-4 py-2 text-sm font-medium text-zinc-100 hover:bg-orange-500 transition ease-in-out duration-300"
               target="_blank">
